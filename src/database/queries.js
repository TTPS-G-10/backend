...
const returnSystems = (transaction) => {
    const sql = `
...
const returnBeds = (transaction) => {
    ...
    const returnBedsAndPatiens = (transaction) => {
        const sql = `
    ...
    const returnBedsWithoutPatients = (transaction) => {
        const sql = `
